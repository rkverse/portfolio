        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{
              ...
              <span style={{ color: "var(--text)", fontWeight: 500 }}>MSc in Applied Data Science</span>{" "}
              at SRM RMP, while running{" "}
              <span style={{ color: "var(--accent)", fontWeight: 500 }}>Cookie</span>{" "}
              ...
              return (
                <div key={cat} style={{ marginBottom: "2.5rem" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "1rem" }}>
                    <span style={{ width: 20, height: 1, background: "var(--line-hover)", display: "inline-block" }} />
                    <h3 style={{
                  ...
                  <div style={{ display: "flex", flexWrap: "wrap", gap: "8px" }}>
                    {catSkills.map((skill) => (
                      <span key={skill.name} style={{
                        ...
                        padding: "0.35rem 0.85rem", borderRadius: "var(--r-sm)",
                      }}>{skill.name}</span>
                    ))}
                  </div>
                </div>
